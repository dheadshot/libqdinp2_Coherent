...
int qdgetch()
{
  ...
  ioctl(STDIN_FILENO, TCGETA, &oldt); /*tcgetattr*/
  newt = oldt;
  newt.c_lflag &= ~( ICANON | ECHO );
  ioctl(STDIN_FILENO, TCSETA, &newt); /*tcsetattr TCSANOW*/
  ch = getchar();
  ioctl(STDIN_FILENO, TCSETA, &oldt); /*tcsetattr TCSANOW*/
  return ch;
}
  ...
  if (ch != EOF )
   {
      if (ch==27)
      {
        ...
        switch (ech)
        {
          ...
          case '7':
            if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_N5;
            return OK_N7;
          break;
...
XTDel:
              ...
              case 'G':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_PGDOWN;
                return OK_N5;
              break;
              ...
              case 'L':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_INS;
                return OK_UNK_3;
              break;

              case 'M':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_F1;
                return OK_UNK_3;
              break;

              case 'N':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_F2;
                return OK_UNK_3;
              break;

              case 'O':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_F3;
                return OK_UNK_3;
              break;

              case 'P':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_F4;
                return OK_PAUSE;
              break;
              
              case 'Q':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_F5;
                return OK_UNK_3;
              break;

              case 'R':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_F6;
                return OK_UNK_3;
              break;

              case 'S':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_F7;
                return OK_UNK_3;
              break;

              case 'T':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_F8;
                return OK_UNK_3;
              break;

              case 'U':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_F9;
                return OK_UNK_3;
              break;

              case 'V':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return OK_F10;
                return OK_UNK_3;
              break;

              case 'Y':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return (OK_SHIFT | OK_F1);
                return OK_UNK_3;
              break;

              case 'Z':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return (OK_SHIFT | OK_F2);
                return OK_UNK_3;
              break;

              case 'a':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return (OK_SHIFT | OK_F3);
                return OK_UNK_3;
              break;

              case 'b':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return (OK_SHIFT | OK_F4);
                return OK_UNK_3;
              break;

              case 'c':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return (OK_SHIFT | OK_F5);
                return OK_UNK_3;
              break;

              case 'd':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return (OK_SHIFT | OK_F6);
                return OK_UNK_3;
              break;

              case 'e':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return (OK_SHIFT | OK_F7);
                return OK_UNK_3;
              break;

              case 'f':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return (OK_SHIFT | OK_F8);
                return OK_UNK_3;
              break;

              case 'g':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return (OK_SHIFT | OK_F9);
                return OK_UNK_3;
              break;

              case 'h':
                if ((strcmp(termtype,"ansipc")==0) || (strcmp(termtype,"ANSIPC")==0)) return (OK_SHIFT | OK_F10);
                return OK_UNK_3;
              break;
